    ...
    <div className='flex'>
      ...
      <form className='flex-1' onSubmit={handleSubmit()}>
        <div style={{margin: '152px 0'}}>
          ...
          {/* 이미지 업로드 시작 */}
          {/*  {{marginBottom: '40px', fontSize: '45px'}} */}
          ...
          <div className='w-[792px] mx-auto'>
            <label htmlFor='name' className='block mb-0'>제목</label>
            <input 
              id='name'
              type='text'
              className='w-full mb-[76px]'
              {...register('name', { 
            ...
            <label htmlFor='content' className='block mb-0'>상세 내용</label>
            <input 
              id='content'
              type='text'
              className='w-full mb-[76px]'
            ...
            <label htmlFor='intro' className='block mb-0'>소개글</label>
            <input 
              id='intro'
              type='text'
              className='w-full mb-[76px]'
            ...
            <button 
              type='submit'
              className='bg-light-main py-7 rounded text-white w-full'
            >
              다음 설정으로 이동
            </button>
          </div>
