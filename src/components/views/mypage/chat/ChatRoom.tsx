  ...
  return (
    <main>
      <div>
        ...
        <p>
          채팅방 링크: {window.location.origin}/chat/{roomId}
        </p>
        ...
        <button onClick={handleJoinRoom} disabled={isJoined}>
          입장
        </button>
        <button onClick={handleLeaveRoom} disabled={!isJoined}>
          퇴장
        </button>
          ...
          <>
            <div>
              <input
                ...
                value={msg}
              />
              <button type="button" disabled={!isJoined} onClick={handleClick}>
                메세지 전송
              </button>
            </div>
          </>
